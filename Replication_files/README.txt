...
"Dual Returns to Experience" by Jose Garcia-Louzao, Laura Hospido, and Alessandro Ruggieri.
...
After having access to the data, replication of the results ask for running for a serious of Stata routines that are included in the 00.Master_File.do
...
The master file includes three main groups of routines:
	1. Transform the data into Stata (.dta) format and create a monthly panel of cohorts.
	2. Select cohorts of interest, implement data cleaning and correction of earnings to obtain the estimation sample.
	3. Estimate the model(s) and retrieve the results. 
